                        ...
                        <div
                            ...
                            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    {{ $performers['data']['count'] }} resultados
                                </p>
                            </div>
                            <!-- End Header -->
                                        ...
                                        <div class="overflow-hidden">
                                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                                ...
                                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                                    @foreach($performers['data']['results'] as $performer)
                                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                                {{ $performer['event_date'] }}
                                                            </td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                                {{ $performer['event_time'] }}
                                                            </td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                                {{ $performer['event_datetext'] }}
                                                            </td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                                {{ $performer['event_datetime'] }}
                                                            </td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                                {{ $performer['venue_name'] }}
                                                            </td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                                {{ $performer['primary_category'] }}
                                                            </td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                                {{ $performer['location']['city_name'] }}, {{ $performer['location']['country_name'] }}
                                                            </td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                                latitud: {{ $performer['geolocation']['latitude'] }} <br>
                                                                longitud: {{ $performer['geolocation']['longitude'] }}
                                                            </td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                                {{ $performer['prices']['currency'] }}
                                                                {{ $performer['prices']['lowPrice'] }}
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
